...
//            let letterMap = """
//                {"V":21,"H":7,"X":23,"F":5,"W":22,"M":12,"E":4,"Y":24,"B":1,"Z":25,"G":6,"R":17,"T":19,"P":15,"L":11,"K":10,"D":3,"S":18,"U":20,"N":13,"A":8,"I":0,"J":9,"C":2,"O":14,"Q":16}
//            """
...
//            
//            #expect(String(gameViewModel.level.attemptedLetters) == expectedAttemptedValues)
//            var foundLetters = "XZ"
//            var idx = 0
//            
//            var char = Array(gameViewModel.level.letterMap!.characterIntMap)[idx].key
//            
//            idx+=1
//            
//            while(foundLetters.contains(String(char))) {
//                char = Array(gameViewModel.level.letterMap!.characterIntMap)[idx].key
//                idx+=1
//            }
//            
...
//            expectedAttemptedValues[alphabetPos] = char
//            
//            if (String(gameViewModel.level.attemptedLetters) != expectedAttemptedValues) {
//                print(char)
//            }
//
//            #expect(String(gameViewModel.level.attemptedLetters) == expectedAttemptedValues)
